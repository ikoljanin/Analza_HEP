...
// Tue Nov 17 08:54:54 2020 by ROOT version 6.22/02
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   public :
	TH2F *electron_2D_histo;
};

#endif

#ifdef Zadatak_2_cxx
Zadatak_2::Zadatak_2(TTree *tree) : fChain(0) 
{
...
Int_t Zadatak_2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Zadatak_2::LoadTree(Long64_t entry)
{
...
void Zadatak_2::Init(TTree *tree)
{
...
void Zadatak_2::Show(Long64_t entry)
{
...
Int_t Zadatak_2::Cut(Long64_t entry)
{
